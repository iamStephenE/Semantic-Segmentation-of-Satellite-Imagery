...
c_model = pruner.compress()
c_model.compile(optimizer='adam', loss=total_loss, metrics=metrics)

hist2 = c_model.fit(X_train, y_train, 
                    batch_size = 16, 
                    verbose=1, 
                    epochs=100, 
                    validation_data=(X_test, y_test), 
                    shuffle=False)
# COMPRESSED MODEL
# c_model.save('models/satellite_standard_unet_100epochs_compressed.hdf5')
